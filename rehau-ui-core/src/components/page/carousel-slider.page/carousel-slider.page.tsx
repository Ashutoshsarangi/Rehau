...
@Component({
  tag: 'carousel-slider-page',
  styleUrl: 'carousel-slider.page.scss',
  shadow: true
})
export class CarouselSliderPage {
  @Prop() public history: RouterHistory;

  public carouselElements: Array<BasicCarouselModel> = [
      {
        content:
  ...
  public render(): any {
    return (
      <main class='main-container'>
        <rh-divider logoText={true} padding={true} text='Carousel ' />
        <rh-carousel-slider
          carousels={this.carouselElements}
        />
      </main>
    );
  }
