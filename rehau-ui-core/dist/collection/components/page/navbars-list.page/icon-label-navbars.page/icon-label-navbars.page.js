...
export class IconLabelNavbarsPage {
    ...
    render() {
        return (h("main", { class: 'main-container' },
            ...
            h("rh-divider", { logoText: true, padding: true, text: '05.04.02 Navbar with Icon and Label' }),
    ...
    static get is() { return "icon-label-navbars-page"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["icon-label-navbars.page.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["icon-label-navbars.page.css"]
    }; }
