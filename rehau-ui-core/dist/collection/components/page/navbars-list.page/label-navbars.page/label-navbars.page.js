...
export class LabelNavbarsPage {
    ...
    render() {
        return (h("main", { class: 'main-container' },
            ...
            h("rh-divider", { logoText: true, padding: true, text: '05.04.02 Navbar with Label' }),
    ...
    static get is() { return "label-navbars-page"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["label-navbars.page.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["label-navbars.page.css"]
    }; }
