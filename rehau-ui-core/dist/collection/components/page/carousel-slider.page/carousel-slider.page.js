...
export class CarouselSliderPage {
    constructor() {
    ...
    render() {
        return (h("main", { class: 'main-container' },
            h("rh-divider", { logoText: true, padding: true, text: 'Carousel ' }),
            h("rh-carousel-slider", { carousels: this.carouselElements })));
    }
    static get is() { return "carousel-slider-page"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() { return {
        "$": ["carousel-slider.page.scss"]
    }; }
    static get styleUrls() { return {
        "$": ["carousel-slider.page.css"]
    }; }
