(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ngx-translate/http-loader'), require('@ngx-translate/core'), require('simple-crypto-js'), require('ionic-cordova-oauth/dist/provider'), require('sha.js'), require('ionic-cordova-oauth'), require('backoff-rxjs'), require('rxjs/operators'), require('@auth0/angular-jwt'), require('@ngrx/store'), require('@angular/router'), require('@angular/animations'), require('q'), require('@angular/common/http'), require('rxjs'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('rehau-functional-core', ['exports', '@ngx-translate/http-loader', '@ngx-translate/core', 'simple-crypto-js', 'ionic-cordova-oauth/dist/provider', 'sha.js', 'ionic-cordova-oauth', 'backoff-rxjs', 'rxjs/operators', '@auth0/angular-jwt', '@ngrx/store', '@angular/router', '@angular/animations', 'q', '@angular/common/http', 'rxjs', '@angular/core'], factory) :
    (factory((global['rehau-functional-core'] = {}),global.httpLoader,global['^12']['1']['2'],global.SimpleCrypto,global.provider,global.shajs,global['0']['0']['9'],global['^6']['3']['3'],global.rxjs.operators,global.angularJwt,global['@ngrx/store'],global.ng.router,global.ng.animations,global.q,global.ng.common.http,global.rxjs,global.ng.core));
}(this, (function (exports,httpLoader,core,SimpleCrypto,provider,shajs,ionicCordovaOauth,backoffRxjs,operators,angularJwt,i1,router,animations,q,i1$1,rxjs,i0) { 'use strict';

    SimpleCrypto = SimpleCrypto && SimpleCrypto.hasOwnProperty('default') ? SimpleCrypto['default'] : SimpleCrypto;
    shajs = shajs && shajs.hasOwnProperty('default') ? shajs['default'] : shajs;
     ...
     */
    /** @type {?} */
    var onBoardingNextStep = i1.createAction('[OnBoarding Step] Manage Next Step', i1.props());
    /** @type {?} */
    var onBoardingBackStep = i1.createAction('[OnBoarding Step] Manage Back Step', i1.props());
    ...
    var RehauFunctionalCoreService = /** @class */ (function () {
        function RehauFunctionalCoreService(store) {
            this.store = store;
            this.onBoardingData$ = store.pipe(i1.select('onBoardingData'));
        }
        /**
         * @return {?}
         */
        ...
        /** @nocollapse */
        RehauFunctionalCoreService.ctorParameters = function () {
            return [
                { type: i1.Store }
            ];
        };
    ...
    ***************************************************************************** */
    ...
    var ConfigService = /** @class */ (function () {
        ...
        ConfigService.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: i0.Inject, args: ['SERVICE_CONFIG',] }] },
                { type: LogService }
            ];
        };
    ...
    /** @type {?} */
    var Reducer = i1.createReducer(initialState, i1.on(onBoardingNextStep, (ɵ0)), i1.on(onBoardingBackStep, (ɵ1)));
    /**
     * @param {?} state
     * @param {?} action
     * @return {?}
     ...
     */
    /** @type {?} */
    var userInfoAction = i1.createAction('User info from CIDAAS', i1.props());
    ...
    /** @type {?} */
    var Reducer$1 = i1.createReducer(initialState$1, i1.on(userInfoAction, (ɵ0$1)));
    /**
     * @param {?} state
     * @param {?} action
     * @return {?}
     ...
     */
    /** @type {?} */
    var loaderAction = i1.createAction('Show-Hide laoder', i1.props());
    ...
    /** @type {?} */
    var Reducer$2 = i1.createReducer(initialState$2, i1.on(loaderAction, (ɵ0$2)));
    /**
     * @param {?} state
     * @param {?} action
     * @return {?}
    ...
    var WebService = /** @class */ (function () {
        ...
        WebService.prototype.getApi =
            ...
            function (url, httpOptions, retryConfig) {
                ...
                if (retryConfig === void 0) {
                    retryConfig = {};
                }
                if (Object.keys(retryConfig).length !== 0) {
                    return this.http.get(url, httpOptions).pipe(operators.timeout(retryConfig.REQ_TIMEOUT), backoffRxjs.retryBackoff({
                        initialInterval: retryConfig.INIT_INTERVAL,
                        maxInterval: retryConfig.MAX_INTERVAL,
                        maxRetries: retryConfig.MAX_RETRIES,
                        shouldRetry: ( /**
         ...
         */
            function (url, requestBody, httpOptions, retryConfig) {
                ...
                if (Object.keys(retryConfig).length !== 0) {
                    return this.http.post(url, requestBody, httpOptions).pipe(operators.timeout(retryConfig.REQ_TIMEOUT), backoffRxjs.retryBackoff({
                        initialInterval: retryConfig.INIT_INTERVAL,
                        maxInterval: retryConfig.MAX_INTERVAL,
                        maxRetries: retryConfig.MAX_RETRIES,
                        shouldRetry: ( /**
         ...
         */
            function (method, url, httpOptions, retryConfig) {
                ...
                if (Object.keys(retryConfig).length !== 0) {
                    return this.http.request(method, url, httpOptions).pipe(operators.timeout(retryConfig.REQ_TIMEOUT), backoffRxjs.retryBackoff({
                        initialInterval: retryConfig.INIT_INTERVAL,
                        maxInterval: retryConfig.MAX_INTERVAL,
                        maxRetries: retryConfig.MAX_RETRIES,
                        shouldRetry: ( /**
        ...
        /** @nocollapse */ WebService.ngInjectableDef = i0.defineInjectable({ factory: function WebService_Factory() { return new WebService(i0.inject(i1$1.HttpClient), i0.inject(LogService), i0.inject("SERVICE_CONFIG")); }, token: WebService, providedIn: "root" });
        return WebService;
    }());
     ...
     */
    /** @type {?} */
    var LoaderFlag = new rxjs.Subject();
    var StoreService = /** @class */ (function () {
        function StoreService(store, logService) {
            this.store = store;
            this.logService = logService;
            this.userData$ = this.store.pipe(i1.select('cidaasData'));
            this.showLoader$ = store.pipe(i1.select('loaderState'));
        }
        /**
         * @param {?} Data
         * @return {?}
    ...
    var AuthService = /** @class */ (function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                user = _a.sent();
                                helper = new angularJwt.JwtHelperService();
        ...
        /** @nocollapse */ AuthService.ngInjectableDef = i0.defineInjectable({ factory: function AuthService_Factory() { return new AuthService(i0.inject(WebService), i0.inject(CacheService), i0.inject(LogService), i0.inject(StoreService), i0.inject("SERVICE_CONFIG")); }, token: AuthService, providedIn: "root" });
        return AuthService;
    }());
    ...
    var LoginService = /** @class */ (function () {
         ...
         */
            function (actionType, platform) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var provider$$1, pkceBody, result, res, err_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (actionType === 'register token') {
                                    ...
                                    provider$$1 = new CidaasProvider(__assign({}, this.cidaasParam, this.cidaasRegisterProvider));
                                }
                                else if (actionType === 'login token') {
                                    // provider = new CidaasProvider({ ...this.cidaasParam, ...cidaasLoginProvider });
                                    provider$$1 = new CidaasProvider(__assign({}, this.cidaasParam, this.cidaasLoginProvider));
                                }
                                pkceBody = {
                                    grant_type: bodyParam.grant_type,
                                    client_id: provider$$1.options.clientId,
                                    redirect_uri: provider$$1.options.redirectUri,
                                    code_verifier: CidaasProvider.base64URLEncode(provider$$1.options.code_challenge)
                                };
                                ...
                                this.logService.log('provider body required for login =' + provider$$1);
                                res = userObject;
                                _a.label = 1;
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, this.login(provider$$1, pkceBody, actionType, platform)];
                            case 2:
                                result = _a.sent();
         ...
         * @return {?}
         */
            function (provider$$1, pkceBody, actionType, platform) {
                return __awaiter(this, void 0, void 0, function () {
                    var res, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (platform === 'browser') {
                                    this.oauth = new ionicCordovaOauth.OauthBrowser();
                                }
                                else {
                                    this.oauth = new ionicCordovaOauth.OauthCordova();
                                }
                                ...
                                if (!(actionType === 'register token'))
                                    return [3 /*break*/, 2];
                                return [4 /*yield*/, this.oauth.logInVia(provider$$1, this.cidaasLoginDesign)];
                            case 1:
                                res = _a.sent();
                                return [3 /*break*/, 4];
                            case 2:
                                if (!(actionType === 'login token'))
                                    return [3 /*break*/, 4];
                                return [4 /*yield*/, this.oauth.logInVia(provider$$1, this.cidaasRegisterDesign)];
                            case 3:
                                res = _a.sent();
                                _a.label = 4;
                            case 4:
    ...
    var AuthGuard = /** @class */ (function () {
        function AuthGuard(logService, authService, router$$1, configuration) {
            this.logService = logService;
            this.authService = authService;
    ...
    var slideInAnimation = animations.trigger('routeAnimations', [
        animations.transition('TabLevel => SecondLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(100%)' }),
                    animations.animate('0.15s linear', animations.style({ transform: 'translateX(0%)' }))
                ], { optional: true }),
                animations.query(':leave', [
                    animations.style({ transform: 'translateX(0%)' }),
                    animations.animate('0.15s linear', animations.style({ transform: 'translateX(-100%)' }))
                ], { optional: true })
            ])
        ]),
        animations.transition('ThirdLevel => ForthLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(100%)' }),
        ...
        animations.transition('SecondLevel => ThirdLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(100%)' }),
        ...
        animations.transition('SecondLevel => TabLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(-100%)' }),
        ...
        animations.transition('ForthLevel => ThirdLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(-100%)' }),
        ...
        animations.transition('ThirdLevel => SecondLevel', [
            animations.query(':enter, :leave', animations.style({ position: 'fixed', width: '100%', height: '100%' }), { optional: true }),
            animations.group([
                animations.query(':enter', [
                    animations.style({ transform: 'translateX(-100%)' }),
        ...
        animations.transition(':decrement', [
            ...
            animations.group([
                animations.query(':enter', [animations.style({ transform: 'translateX(-100%)' }), animations.animate('.3s ease-out', animations.style({ transform: 'translateX(0%)' }))], {
                    optional: true,
                }),
                animations.query(':leave', [animations.style({ transform: 'translateX(0%)' }), animations.animate('.3s ease-out', animations.style({ transform: 'translateX(100%)' }))], {
                    optional: true,
                }),
            ]),
        ]),
    ...
    var GatewayAclService = /** @class */ (function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            ...
                            case 1:
                                httpOptions = (_a.headers = new (_b.apply(i1$1.HttpHeaders, [void 0, (_c[_d] = _e.sent(),
                                        _c)]))(),
                                    _a);
        ...
        /** @nocollapse */
        GatewayAclService.ctorParameters = function () {
            return [
                { type: i1$1.HttpClient },
                { type: AuthService },
                { type: WebService },
        ...
        /** @nocollapse */ GatewayAclService.ngInjectableDef = i0.defineInjectable({ factory: function GatewayAclService_Factory() { return new GatewayAclService(i0.inject(i1$1.HttpClient), i0.inject(AuthService), i0.inject(WebService), i0.inject(LogService)); }, token: GatewayAclService, providedIn: "root" });
    ...
    var GatewayService = /** @class */ (function () {
         ...
         */
            function (gateway, apiEndpoint, method, body, headers, connectionType, retryLocal, retryRemote, killRequestObject, localResponseType) {
                ...
                if (retryLocal === void 0) {
                    retryLocal = 2;
                }
                if (retryRemote === void 0) {
                    retryRemote = 3;
                }
                if (killRequestObject === void 0) {
                    killRequestObject = { continue: true };
                }
                if (localResponseType === void 0) {
                    localResponseType = 'json';
                }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_f) {
                        switch (_f.label) {
                            ...
                            case 10:
                                if (!(connectionType === 'local' || connectionType === 'admin'))
                                    return [3 /*break*/, 18];
        ...
        /** @nocollapse */ GatewayService.ngInjectableDef = i0.defineInjectable({ factory: function GatewayService_Factory() { return new GatewayService(i0.inject(i1$1.HttpClient), i0.inject(GatewayAclService), i0.inject(AuthService), i0.inject(CacheService), i0.inject(WebService), i0.inject(LogService)); }, token: GatewayService, providedIn: "root" });
    ...
    var GatewayDeviceControlService = /** @class */ (function () {
        ...
        /** @nocollapse */
        GatewayDeviceControlService.ctorParameters = function () {
            return [
                { type: AuthService },
                { type: WebService }
            ];
        };
        /** @nocollapse */ GatewayDeviceControlService.ngInjectableDef = i0.defineInjectable({ factory: function GatewayDeviceControlService_Factory() { return new GatewayDeviceControlService(i0.inject(AuthService), i0.inject(WebService)); }, token: GatewayDeviceControlService, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var onlineOfflineData = new rxjs.Subject();
    var OnlineOfflineService = /** @class */ (function () {
        function OnlineOfflineService(authService, gatewayService, logService) {
            ...
            this.failureRate = new rxjs.BehaviorSubject(0);
        ...
        /** @nocollapse */
        OnlineOfflineService.ctorParameters = function () {
            return [
                { type: AuthService },
                { type: GatewayService },
                { type: LogService }
        ...
        /** @nocollapse */ OnlineOfflineService.ngInjectableDef = i0.defineInjectable({ factory: function OnlineOfflineService_Factory() { return new OnlineOfflineService(i0.inject(AuthService), i0.inject(GatewayService), i0.inject(LogService)); }, token: OnlineOfflineService, providedIn: "root" });
    ...
    var SensorSettingService = /** @class */ (function () {
        ...
        /** @nocollapse */
        SensorSettingService.ctorParameters = function () {
            return [
                { type: CacheService }
            ];
        };
        /** @nocollapse */ SensorSettingService.ngInjectableDef = i0.defineInjectable({ factory: function SensorSettingService_Factory() { return new SensorSettingService(i0.inject(CacheService)); }, token: SensorSettingService, providedIn: "root" });
     ...
     */
    /** @type {?} */
    var sensorUpdateSub = new rxjs.Subject();
    /** @type {?} */
    var sensorsDataSub = new rxjs.Subject();
    var ZAutomationService = /** @class */ (function () {
                        ...
                        switch (_b.label) {
                            ...
                            case 3:
                                ...
                                try {
                                    ...
                                    try {
                                        if (pollObject_1_1 && !pollObject_1_1.done && (_a = pollObject_1.return))
                                            _a.call(pollObject_1);
                                    }
                                    finally {
                                        if (e_2)
                                            throw e_2.error;
        ...
        /** @nocollapse */
        ZAutomationService.ctorParameters = function () {
            return [
        ...
        /** @nocollapse */ ZAutomationService.ngInjectableDef = i0.defineInjectable({ factory: function ZAutomationService_Factory() { return new ZAutomationService(i0.inject(OnlineOfflineService), i0.inject(AuthService), i0.inject(GatewayService), i0.inject(SensorSettingService), i0.inject(LogService), i0.inject(CacheService)); }, token: ZAutomationService, providedIn: "root" });
    ...
    exports.RehauFunctionalCoreService = RehauFunctionalCoreService;
    exports.RehauFunctionalCoreModule = RehauFunctionalCoreModule;
    exports.reducers = reducers;
    exports.CacheService = CacheService;
    exports.LogService = LogService;
    exports.LoginService = LoginService;
    exports.AuthService = AuthService;
    exports.LoaderFlag = LoaderFlag;
    exports.StoreService = StoreService;
    exports.TranslationService = TranslationService;
    exports.AuthGuard = AuthGuard;
    exports.slideInAnimation = slideInAnimation;
    exports.OnBoardingService = OnBoardingService;
    exports.GatewayAlreadyConfiguredError = GatewayAlreadyConfiguredError;
    exports.GatewaySerialNotFoundError = GatewaySerialNotFoundError;
    exports.GatewayService = GatewayService;
    exports.GatewayAclService = GatewayAclService;
    exports.GatewayDeviceControlService = GatewayDeviceControlService;
    exports.sensorUpdateSub = sensorUpdateSub;
    exports.sensorsDataSub = sensorsDataSub;
    exports.ZAutomationService = ZAutomationService;
    exports.ɵe = ConfigService;
    exports.ɵd = CONFIG_FACTORY;
    exports.ɵs = SensorSettingService;
    exports.ɵr = OnlineOfflineService;
    exports.ɵa = HttpLoaderFactory;
    exports.ɵb = TRANSLATE_FACTORY;
    exports.ɵc = TranslateServiceModule;
    exports.ɵq = WebService;
    exports.ɵm = userInfoAction;
    exports.ɵl = cidaasReducer;
    exports.ɵk = initialState$1;
    exports.ɵp = loaderAction;
    exports.ɵn = initialState$2;
    exports.ɵo = loaderReducer;
    exports.ɵj = onBoardingBackStep;
    exports.ɵi = onBoardingNextStep;
    exports.ɵg = initialState;
    exports.ɵh = onBoardingReducer;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=rehau-functional-core.umd.js.map